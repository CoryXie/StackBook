...
/**
  * @class Provides means for retrieving paged data from the StackOverflowAPI.
  * @description This class actually performs the requests for data in the StackOverflowAPI.
  *
  * @param {StackOverflowURL} url the base StackOverflowURL to use for requests
  */
export default class StackOverflowResponse {

    constructor (url) {
        // Store a copy of the base StackOverflowURL
        let _url = url;
        ...
        this.Fetch = function(callback, fetch_multiple) {
            ...
            // Fetch the JSON data
            StackOverflowAPI.FetchJSON(_url, function(data) {
        ...
        /**
          ...
          * @returns {StackOverflowResponse} the current instance
          */
