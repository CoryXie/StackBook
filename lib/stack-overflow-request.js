...
/**
  ...
  *
  * @param {StackOverflowURL} url the URL for the request
  */
export default class StackOverflowRequest {
    ...
    constructor (url) {
        ...
        /**
          ...
          *
          * @returns {StackOverflowResponse} the response for the request
          */
        this.Exec = function() {

            return new StackOverflowResponse(_url);
        };
        ...
        /**
          ...
          * @returns {StackOverflowRequest} the current instance
          */
