...
export default class URL {
    ...
    constructor (domain_name) {
        ...
        let _prefix     = URL.AutoRequestPrefix;
        let _parameters = [];
        let _ids        = [];
        let _tags       = [];
        ...
        this.CompleteURL = function() {
            ...
            var url = (_prefix == URL.SecureRequestPrefix)?'https':'http';
        ...
        /**
          ...
          *
          * <p>Note that the provided value will be ignored unless URL.DefaultPrefix
          * is set to URL.AutoRequestPrefix.</p>
          *
          * @param {integer} prefix the prefix to use
          * @returns {URL} the current instance
          */
        this.SetPrefix = function(prefix) {

            if (URL.DefaultPrefix == URL.AutoRequestPrefix)
                _prefix = prefix;
        ...
        /**
          * Adds a parameter to the the method of the URL.
          *
        ...
        /**
          * Adds the provided ID(s) to the URL.
          *
        ...
        /**
          * Adds the provided tag(s) to the URL.
          *
        ...
        /**
          * Adds the specified query string parameter to the URL.
          *
...
URL.AutoRequestPrefix     = 0;
/** Uses the standard (HTTP) prefix. */
URL.StandardRequestPrefix = 1;
/** Uses the secure (HTTPS) prefix. */
URL.SecureRequestPrefix   = 2;
/** The default prefix used for new URLs. */
URL.DefaultPrefix = URL.AutoRequestPrefix;
