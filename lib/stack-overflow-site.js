...
export default class Site {
    ...
    constructor (site_data) {
        ...
        this.Answers = function(id) {
            return new Request(new URL(_domain_name)).Answers(id);
        };
        ...
        this.Badges = function(id) {
            return new Request(new URL(_domain_name)).Badges(id);
        };
        ...
        this.Comments = function(id) {
            return new Request(new URL(_domain_name)).Comments(id);
        };
        ...
        this.Errors = function(id) {
            return new Request(new URL(_domain_name)).Errors(id);
        };
        ...
        this.Events = function() {
            return new Request(new URL(_domain_name)).Events();
        };
        ...
        /**
          ...
          */
        this.Info = function() {
            return new Request(new URL(_domain_name)).Info();
        };
        ...
        this.Posts = function(id) {
            return new Request(new URL(_domain_name)).Posts(id);
        };
        ...
        this.Privileges = function() {
            return new Request(new URL(_domain_name)).Privileges();
        };
        ...
        this.Questions = function(id) {
            return new Request(new URL(_domain_name)).Questions(id);
        };
        ...
        this.Revisions = function(id) {
            return new Request(new URL(_domain_name)).Revisions(id);
        };
        ...
        this.Search = function() {
            return new Request(new URL(_domain_name)).Search();
        };
        ...
        this.Similar = function() {
            return new Request(new URL(_domain_name)).Similar();
        };
        ...
        this.SuggestedEdits = function(id) {
            return new Request(new URL(_domain_name)).SuggestedEdits(id);
        };
        ...
        this.Tags = function(tag) {
            return new Request(new URL(_domain_name)).Tags(tag);
        };
        ...
        this.Users = function(id) {
            return new Request(new URL(_domain_name)).Users(id);
        };
    }
}
